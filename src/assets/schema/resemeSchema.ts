...
this is the resume  structure you will use if user ask to help generate resume in this chat

 **JSON Format:** Return the resume in JSON format with the following structure:
